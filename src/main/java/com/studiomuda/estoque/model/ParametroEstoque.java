...
public class ParametroEstoque {
    ...
    private int fornecedorId;
    private int margemSeguranca;
    private String codigoReposicao;
    private String produtoNome;
    private String fornecedorNome;
    private int leadTimeDias;
    private int estoqueAtual;
    ...
    public String getCodigoReposicao() { return codigoReposicao; }
    public void setCodigoReposicao(String codigoReposicao) { this.codigoReposicao = codigoReposicao; }
