...
('Adubo OrgÃ¢nico Premium', 'Adubo para plantas 5kg super concentrado', 'Materiais', 120, 28.90),
...
('Pedra Brita Decorativa', 'Pedra brita colorida para decoraÃ§Ã£o', 'Materiais', 45, 42.00),
('Piso Drenante Jardim', 'Piso modular drenante para Ã¡reas externas', 'Materiais', 150, 65.00),
('Manta GeotÃªxtil', 'Manta para controle de ervas daninhas', 'Materiais', 25, 89.90),
...
('Kit Jardinagem Completo', 'Kit com pÃ¡s, ancinhos, regadores e luvas', 'Ferramentas', 50, 95.00),
...
('RÃ©gua de Plantio', 'RÃ©gua graduada para mediÃ§Ã£o de Ã¡reas', 'Ferramentas', 60, 28.90),
('Borrifador Spray', 'Borrifador spray para plantas', 'Ferramentas', 80, 15.90),
('Ancinho de Folhas', 'Ancinho especÃ­fico para coleta de folhas', 'Ferramentas', 30, 52.00),

('Cortador de Grama ElÃ©trico', 'Cortador elÃ©trico 1500W com recolhedor', 'Equipamentos', 18, 450.00),
('Aspirador de Folhas', 'Aspirador/soprador de folhas 2000W', 'Equipamentos', 12, 320.00),
('Motosserra de Poda', 'Motosserra elÃ©trica para poda de galhos', 'Equipamentos', 8, 280.00),
('RoÃ§adeira ElÃ©trica', 'RoÃ§adeira elÃ©trica 1200W profissional', 'Equipamentos', 15, 390.00),
('Mangueira de Jardim', 'Mangueira flexÃ­vel 30 metros', 'Equipamentos', 25, 85.00),
('Bancada Jardinagem MÃ³vel', 'Bancada com rodas para trabalho', 'Equipamentos', 10, 380.00),

('IluminaÃ§Ã£o LED Solar', 'LÃ¢mpada LED solar para jardim', 'AcessÃ³rios', 75, 68.00),
('Vaso CerÃ¢mica Grande', 'Vaso decorativo de cerÃ¢mica 40cm', 'AcessÃ³rios', 30, 95.00),
('Timer para IrrigaÃ§Ã£o', 'Timer automÃ¡tico para sistema de irrigaÃ§Ã£o', 'AcessÃ³rios', 20, 150.00),
('Suporte para Plantas', 'Suporte metÃ¡lico ajustÃ¡vel para plantas', 'AcessÃ³rios', 55, 42.90),
('Fertilizante LÃ­quido', 'Fertilizante concentrado NPK 500ml', 'AcessÃ³rios', 90, 24.90),

('Herbicida Seletivo', 'Herbicida para controle de ervas', 'Materiais', 5, 85.00),
('Bomba de IrrigaÃ§Ã£o', 'Bomba submersa para irrigaÃ§Ã£o', 'Equipamentos', 3, 680.00),
('Sensor de Umidade', 'Sensor digital de umidade do solo', 'AcessÃ³rios', 2, 220.00),

('Adubo Especial OrquÃ­deas', 'Adubo especÃ­fico para orquÃ­deas', 'Materiais', 0, 35.90),
('Cortador de Cerca Viva', 'Cortador elÃ©trico para cerca viva', 'Equipamentos', 0, 590.00);
...
('Ana Paula Diretor', '12345678901', 'Diretor', '1980-02-15', '(11) 99888-7766', '01234-567', 'Rua dos Jardins', '123', 'Centro', 'SÃ£o Paulo', 'SP', true),
('Carlos Eduardo Diretor', '23456789012', 'Diretor', '1978-11-08', '(11) 99777-8855', '02345-678', 'Av. Verde', '456', 'Vila Verde', 'SÃ£o Paulo', 'SP', true),

('Fernanda Silva Gerente', '34567890123', 'Gerente', '1985-06-10', '(11) 99666-5544', '03456-789', 'Rua das Flores', '789', 'Vila Nova', 'SÃ£o Paulo', 'SP', true),
('Roberto Santos Gerente', '45678901234', 'Gerente', '1982-09-22', '(11) 99555-4433', '04567-890', 'Av. Brasil', '1010', 'ConsolaÃ§Ã£o', 'SÃ£o Paulo', 'SP', true),

('Juliana Costa Vendas', '56789012345', 'Vendedor', '1990-03-30', '(11) 99444-3322', '05678-901', 'Rua das Palmeiras', '234', 'Pinheiros', 'SÃ£o Paulo', 'SP', true),
('Marcos Oliveira Vendas', '67890123456', 'Vendedor', '1988-12-14', '(11) 99333-2211', '06789-012', 'Av. Paulista', '567', 'Bela Vista', 'SÃ£o Paulo', 'SP', true),
('PatrÃ­cia Almeida Vendas', '78901234567', 'Vendedor', '1992-07-25', '(11) 99222-1100', '07890-123', 'Rua Augusta', '890', 'Cerqueira CÃ©sar', 'SÃ£o Paulo', 'SP', true),

('JoÃ£o Pedro Estoque', '89012345678', 'Estoquista', '1995-01-18', '(11) 99111-0099', '08901-234', 'Rua do ComÃ©rcio', '321', 'RepÃºblica', 'SÃ£o Paulo', 'SP', true),
('Maria JosÃ© Estoque', '90123456789', 'Estoquista', '1993-04-05', '(11) 99000-9988', '09012-345', 'Av. SÃ£o JoÃ£o', '654', 'Centro', 'SÃ£o Paulo', 'SP', true),

('Lucas Silva Auxiliar', '01234567890', 'Auxiliar', '1997-08-12', '(11) 98899-8877', '10123-456', 'Rua da Liberdade', '987', 'Liberdade', 'SÃ£o Paulo', 'SP', true),
('Camila Santos Auxiliar', '11234567801', 'Auxiliar', '1996-10-30', '(11) 98788-7766', '11234-567', 'Rua VoluntÃ¡rios', '159', 'Santana', 'SÃ£o Paulo', 'SP', true),

('Pedro Inativo', '22334455667', 'Auxiliar', '1994-05-15', '(11) 98677-6655', '12345-678', 'Rua Teste', '753', 'Vila Test', 'SÃ£o Paulo', 'SP', false);

INSERT INTO cliente (nome, cpf_cnpj, telefone, email, tipo, ativo, cep, rua, numero, bairro, cidade, estado, dataNascimento) VALUES
('Maria Silva Santos', '11122233344', '(11) 98765-4321', 'maria@email.com', 'PF', true, '01310-100', 'Av. Paulista', '1000', 'Jardim Paulista', 'SÃ£o Paulo', 'SP', '1985-05-21'),
('Carlos Roberto Lima', '22233344455', '(11) 97654-3210', 'carlos@email.com', 'PF', true, '04038-001', 'Rua Augusta', '2500', 'Moema', 'SÃ£o Paulo', 'SP', '1978-11-03'),
('Beatriz Torres Oliveira', '33344455566', '(11) 96543-2109', 'beatriz@email.com', 'PF', true, '05422-001', 'Rua Teodoro Sampaio', '300', 'Itaim', 'SÃ£o Paulo', 'SP', '1990-02-14'),
('JoÃ£o Pedro Costa', '44455566677', '(11) 95432-1098', 'joao@email.com', 'PF', true, '01402-001', 'Rua da ConsolaÃ§Ã£o', '1500', 'ConsolaÃ§Ã£o', 'SÃ£o Paulo', 'SP', '1983-08-30'),
('Ana Claudia Rocha', '55566677788', '(11) 94321-0987', 'ana@email.com', 'PF', true, '01310-200', 'Rua Haddock Lobo', '800', 'Cerqueira CÃ©sar', 'SÃ£o Paulo', 'SP', '1992-12-08'),
...
('Fernanda Almeida', '77788899900', '(11) 92109-8765', 'fernanda@email.com', 'PF', true, '12900-000', 'Av. Brasil', '789', 'Vila Nova', 'BraganÃ§a Paulista', 'SP', '1989-09-22'),
('Paulo Santos Junior', '88899900011', '(11) 91098-7654', 'paulo@email.com', 'PF', true, '18100-000', 'Rua das Flores', '123', 'Jardim AmÃ©rica', 'Sorocaba', 'SP', '1975-06-12'),

('Luciana Martins', '99900011122', '(21) 98765-4321', 'luciana@email.com', 'PF', true, '22071-900', 'Av. AtlÃ¢ntica', '2000', 'Copacabana', 'Rio de Janeiro', 'RJ', '1984-01-25'),
...
('Paisagismo Premium LTDA', '12345678000190', '(11) 3322-1100', 'contato@paisagismopremium.com', 'PJ', true, '04543-001', 'Av. Faria Lima', '3000', 'Itaim Bibi', 'SÃ£o Paulo', 'SP', NULL),
('Jardins & Cia Empreendimentos', '23456789000101', '(11) 3311-2200', 'vendas@jardinsecia.com', 'PJ', true, '01310-915', 'Av. Paulista', '1500', 'Bela Vista', 'SÃ£o Paulo', 'SP', NULL),
('Verde Vida Paisagismo S/A', '34567890000112', '(11) 3300-3300', 'comercial@verdevida.com', 'PJ', true, '04702-000', 'Av. Santo Amaro', '5000', 'Brooklin', 'SÃ£o Paulo', 'SP', NULL),

('ConstruÃ§Ãµes Floridas LTDA', '45678901000123', '(11) 3299-4400', 'obras@construfloridas.com', 'PJ', true, '03031-000', 'Rua do GasÃ´metro', '800', 'BrÃ¡s', 'SÃ£o Paulo', 'SP', NULL),
('Residencial Garden', '56789012000134', '(11) 3288-5500', 'contato@residencialgarden.com', 'PJ', true, '02033-000', 'Av. Cruzeiro do Sul', '1200', 'Santana', 'SÃ£o Paulo', 'SP', NULL),
...
('Empresa Inativa LTDA', '89012345000167', '(11) 3255-8800', 'inativa@empresa.com', 'PJ', false, '01000-000', 'Rua Teste', '999', 'Centro', 'SÃ£o Paulo', 'SP', NULL),
('Cliente Inativo PF', '90123456789', '(11) 99999-9999', 'inativo@email.com', 'PF', false, '00000-000', 'Rua Inativa', '000', 'Teste', 'SÃ£o Paulo', 'SP', '1990-01-01');

INSERT INTO cupom (codigo, descricao, valor, data_inicio, validade, condicoes_uso) VALUES
('BEMVINDO10', 'Cupom de boas-vindas R$ 10,00', 10.00, '2024-01-01', '2025-12-31', 'VÃ¡lido para primeira compra'),
('PROMOCAO20', 'PromoÃ§Ã£o especial R$ 20,00', 20.00, '2024-05-01', '2025-06-30', 'Compras acima de R$ 100,00'),
('ANIVERSARIO50', 'Super desconto aniversÃ¡rio R$ 50,00', 50.00, '2024-05-01', '2025-05-31', 'Compras acima de R$ 300,00'),
('INDICACAO15', 'Indique um amigo R$ 15,00', 15.00, '2024-04-01', '2025-12-31', 'VÃ¡lido uma vez por cliente'),
('FIDELIDADE25', 'Cliente fiel R$ 25,00', 25.00, '2024-06-01', '2025-12-31', 'Clientes com mais de 3 compras'),
('NATAL30', 'PromoÃ§Ã£o de Natal R$ 30,00', 30.00, '2024-12-01', '2025-01-15', 'VÃ¡lido atÃ© Janeiro'),
('BLACKFRIDAY', 'Black Friday R$ 40,00', 40.00, '2024-11-20', '2025-11-30', 'PromoÃ§Ã£o especial'),
('JARDIM5', 'Desconto jardim R$ 5,00', 5.00, '2024-03-01', '2025-12-31', 'Produtos categoria Materiais'),

('VERAO2024', 'PromoÃ§Ã£o de verÃ£o R$ 35,00', 35.00, '2024-01-01', '2024-03-31', 'Cupom vencido'),
('INVERNO2024', 'PromoÃ§Ã£o de inverno R$ 45,00', 45.00, '2024-06-01', '2024-08-31', 'Cupom vencido'),
...
(1, 'entrada', 100, 'ReposiÃ§Ã£o estoque - Fornecedor ABC', '2024-01-03'),
(2, 'entrada', 200, 'ReposiÃ§Ã£o estoque - Fornecedor Sementes', '2024-01-03'),
(3, 'entrada', 50, 'ReposiÃ§Ã£o estoque - Terra FÃ©rtil Ltda', '2024-01-05'),
(16, 'entrada', 10, 'Compra equipamentos - Fornecedor Tech', '2024-01-08'),
(17, 'entrada', 8, 'Compra equipamentos - Fornecedor Tech', '2024-01-08'),

(6, 'entrada', 80, 'ReposiÃ§Ã£o piso - Construtora Pisos', '2024-02-01'),
(9, 'entrada', 20, 'ReposiÃ§Ã£o ferramentas - Jardinex', '2024-02-03'),
(21, 'entrada', 50, 'ReposiÃ§Ã£o iluminaÃ§Ã£o - LED Solar Co', '2024-02-05'),
(22, 'entrada', 25, 'ReposiÃ§Ã£o vasos - CerÃ¢mica Bela', '2024-02-10'),

(4, 'entrada', 40, 'ReposiÃ§Ã£o substrato - Substratos SP', '2024-03-01'),
(10, 'entrada', 30, 'ReposiÃ§Ã£o kits - Jardinex', '2024-03-05'),
(23, 'entrada', 15, 'Compra timers - IrrigaÃ§Ã£o Pro', '2024-03-08'),
(25, 'entrada', 60, 'ReposiÃ§Ã£o fertilizante - Nutriplan', '2024-03-12'),

(18, 'entrada', 5, 'Compra motosserra - EquipGarden', '2024-04-02'),
(19, 'entrada', 8, 'Compra roÃ§adeira - EquipGarden', '2024-04-02'),
(5, 'entrada', 30, 'ReposiÃ§Ã£o brita - Pedreira Central', '2024-04-05'),
(26, 'entrada', 10, 'Compra herbicida - AgroQuÃ­mica', '2024-04-10'),

(1, 'entrada', 150, 'ReposiÃ§Ã£o alta temporada - ABC', '2024-05-01'),
(2, 'entrada', 250, 'ReposiÃ§Ã£o alta temporada - Sementes', '2024-05-01'),
(3, 'entrada', 80, 'ReposiÃ§Ã£o alta temporada - Terra FÃ©rtil', '2024-05-03'),
(6, 'entrada', 100, 'ReposiÃ§Ã£o alta temporada - Pisos', '2024-05-05'),
(21, 'entrada', 80, 'ReposiÃ§Ã£o alta temporada - LED Solar', '2024-05-08'),

(7, 'entrada', 15, 'ReposiÃ§Ã£o manta - GeotÃªxtil Pro', '2024-06-01'),
(8, 'entrada', 25, 'ReposiÃ§Ã£o casca - Pinus DecoraÃ§Ã£o', '2024-06-05'),
(11, 'entrada', 20, 'ReposiÃ§Ã£o pulverizador - Jardinex', '2024-07-01'),
(12, 'entrada', 25, 'ReposiÃ§Ã£o enxada - Ferramentas Sul', '2024-07-15'),
(20, 'entrada', 15, 'ReposiÃ§Ã£o mangueira - Hidro Flex', '2024-08-01'),
(24, 'entrada', 40, 'ReposiÃ§Ã£o suporte - Metal Garden', '2024-08-10'),
(27, 'entrada', 5, 'Compra bomba - IrrigaÃ§Ã£o Pro', '2024-09-01'),
(28, 'entrada', 8, 'Compra sensor - Tech Garden', '2024-09-05'),
(13, 'entrada', 30, 'ReposiÃ§Ã£o rÃ©gua - Medidas Precisas', '2024-10-01'),
(14, 'entrada', 50, 'ReposiÃ§Ã£o borrifador - Spray Tech', '2024-10-05'),
(15, 'entrada', 20, 'ReposiÃ§Ã£o ancinho - Ferramentas Sul', '2024-11-01'),
(21, 'entrada', 40, 'ReposiÃ§Ã£o fim ano - LED Solar', '2024-12-01');
...
(3, 'entrada', 5, 'DevoluÃ§Ã£o cliente - Pedido #18', '2024-05-10'),
(14, 'saida', 2, 'Amostra grÃ¡tis - cliente premium', '2024-05-15'),
(25, 'saida', 3, 'Uso interno - teste qualidade', '2024-05-20'),

(1, 'entrada', 80, 'ReposiÃ§Ã£o Janeiro 2025 - ABC', '2025-01-02'),
(2, 'entrada', 150, 'ReposiÃ§Ã£o Janeiro 2025 - Sementes', '2025-01-02'),
(16, 'entrada', 5, 'ReposiÃ§Ã£o equipamentos 2025', '2025-01-05'),
...
UNION ALL
SELECT 'FuncionÃ¡rios inseridos:', COUNT(*) FROM funcionario
UNION ALL
...
UNION ALL
SELECT 'MovimentaÃ§Ãµes estoque:', COUNT(*) FROM movimentacao_estoque;

SELECT '==================== PRODUTOS POR CATEGORIA ====================' AS 'STATUS';
SELECT tipo AS 'Categoria', COUNT(*) AS 'Qtd_Produtos', SUM(quantidade) AS 'Estoque_Total',
       ROUND(AVG(valor), 2) AS 'Valor_MÃ©dio'
FROM produto
GROUP BY tipo
ORDER BY COUNT(*) DESC;

SELECT '==================== FUNCIONÃRIOS POR CARGO ====================' AS 'STATUS';
SELECT cargo AS 'Cargo', COUNT(*) AS 'Quantidade',
       CASE WHEN COUNT(*) > 0 THEN 'Adequado' ELSE 'Sem funcionÃ¡rios' END AS 'Status'
FROM funcionario
WHERE ativo = true
GROUP BY cargo
ORDER BY COUNT(*) DESC;

SELECT '==================== CLIENTES POR TIPO E REGIÃƒO ====================' AS 'STATUS';
...
SELECT '==================== VENDAS POR MÃŠS (2024) ====================' AS 'STATUS';
SELECT
    YEAR(data_requisicao) AS 'Ano',
    MONTH(data_requisicao) AS 'MÃªs',
...
SELECT '==================== FUNCIONÃRIOS POR DESEMPENHO ====================' AS 'STATUS';
SELECT
    f.nome AS 'FuncionÃ¡rio',
    f.cargo AS 'Cargo',
...
SELECT '==================== ESTOQUE CRÃTICO (BAIXO) ====================' AS 'STATUS';
SELECT
    nome AS 'Produto',
    tipo AS 'Categoria',
    ...
    CASE
        ...
        WHEN quantidade <= 5 THEN 'CRÃTICO'
...
SELECT '==================== MOVIMENTAÃ‡Ã•ES RECENTES (ÃšLTIMOS 30 DIAS) ====================' AS 'STATUS';
SELECT
    p.nome AS 'Produto',
    me.tipo AS 'Tipo_MovimentaÃ§Ã£o',
...
SELECT 'Dashboard estÃ¡ pronto para teste com dados abrangentes e realistas!' AS 'RESULTADO';
